...
//	WebElement chiffon_picture;
	 ...
	 * assigns WebDriver instance to corresponding references for all the 
	 * page objects and utilities. It also initializes the page factory objects.
	 * @param driver
...
//		this.wait = wait;
	...
	/**
	 * This method moves the mouse over first level menu items - Women, Dresses & T-shirts
	...
	/**
	 * This method checks if "your logo new experience" is displayed
	 * This helps in validating that AUT has been launched successfully
	...
	/**
	 * This method clicks on 2nd level menu items once user hovers over main menu and
	 * 2nd level menu items are displayed
	 ...
	 * This helps in validating that correct results are displayed
	...
	/**
	 * This method hovers mouse over a particular product on the product results page
	...
	/**
	 * This method checks if quick view option is displayed when hovered over a product
	 * on results page
	...
	/**
	 * This method checks product has been added to the cart upon clicking
	 * add to cart button
	...
	/**
	 * This method takes the user to the checkout page. It clicks on check out button
	 * displayed after hovering over my cart
	 * @author Mitulsinh Vaghela
	 */	
